...
- These are one-day scoring results for 2022-06-13.
...
- Keep threshold: **0.5**. Tracks with fewer than
  ...
  filtering metrics (NaN score; 61,542 such track-rows here).
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| -5 | 19,846 | 174 | 0.9735 | 0.7879 | 1 | 0.0065 | gru_ae | track_purity | 0.9806 | 0.9943 | 0.9999 |
| 0 | 20,217 | 24 | 0.9854 | 0.6365 | 1 | 0.0006 | gru_ae | track_purity | 0.9719 | 0.9583 | 0.9999 |
| 3 | 18,837 | 5 | 0.9844 | 0.5524 | 1 | 0 | gru_ae | track_purity | 0.9628 | 1 | 1 |
| 6 | 16,266 | 0 | 0.9818 | 0.4781 | 1 | 0 | gru_ae | track_purity | 0.9609 | nan | 1 |
| -5 | 19,846 | 174 | 0.9735 | 0.7879 | 1 | 0.0065 | mlp_dae | track_purity | 0.9833 | 0.9943 | 0.9999 |
| 0 | 20,217 | 24 | 0.9854 | 0.6365 | 1 | 0.0006 | mlp_dae | track_purity | 0.9757 | 1 | 1 |
| 3 | 18,837 | 5 | 0.9844 | 0.5524 | 1 | 0 | mlp_dae | track_purity | 0.9649 | 1 | 1 |
| 6 | 16,266 | 0 | 0.9818 | 0.4781 | 1 | 0 | mlp_dae | track_purity | 0.9607 | nan | 1 |
| -5 | 19,846 | 174 | 0.9735 | 0.7879 | 1 | 0.0065 | tcn_ae | track_purity | 0.9424 | 0.9770 | 0.9998 |
| 0 | 20,217 | 24 | 0.9854 | 0.6365 | 1 | 0.0006 | tcn_ae | track_purity | 0.9238 | 0.9167 | 0.9999 |
| 3 | 18,837 | 5 | 0.9844 | 0.5524 | 1 | 0 | tcn_ae | track_purity | 0.9194 | 1 | 1 |
| 6 | 16,266 | 0 | 0.9818 | 0.4781 | 1 | 0 | tcn_ae | track_purity | 0.9362 | nan | 1 |

## Model comparison

- **gru_ae**: mean false reduction 0.984, mean true retention 0.969.
- **mlp_dae**: mean false reduction 0.998, mean true retention 0.971.
- **tcn_ae**: mean false reduction 0.965, mean true retention 0.930.

## Range-bin behavior

| model | range_bin | tracks | true_retention | false_reduction | median_score |
|---:|---:|---:|---:|---:|---:|
| gru_ae | 0-50 km | 40,562 | 0.9958 | 0.9842 | 1 |
| gru_ae | 50-100 km | 33,558 | 0.9374 | nan | 0.8899 |
| gru_ae | 100-200 km | 1,249 | 0.7632 | nan | 0.7432 |
| mlp_dae | 0-50 km | 40,562 | 0.9959 | 0.9981 | 1 |
| mlp_dae | 50-100 km | 33,558 | 0.9408 | nan | 0.9073 |
| mlp_dae | 100-200 km | 1,249 | 0.7757 | nan | 0.7353 |
| tcn_ae | 0-50 km | 40,562 | 0.9973 | 0.9646 | 1 |
| tcn_ae | 50-100 km | 33,558 | 0.8612 | nan | 0.8091 |
| tcn_ae | 100-200 km | 1,249 | 0.4075 | nan | 0.3877 |

## Score separability

Median sequence score (pooled models): true 0.968 vs false 0.000.
...
|---:|---:|---:|---:|---:|
| gru_ae | 0.5089 | 7.3200 | 0.4200 | 3.2303 |
| mlp_dae | 0.2401 | 3.9641 | 0.2036 | 1.8129 |
| tcn_ae | 0.0375 | 0.3563 | 0.0289 | 0.1999 |
...
Calibration tracks: dates 2022-06-13; thresholds 3, 6 dB; eligibility target_fraction >= 0.95 and purity >= 0.95 (higher thresholds are used for calibration because they yield cleaner, more reliable high-purity true tracks).
...
| gru_ae | track_purity | 0.4200 | 0.9713 | 3.2303 | 11,672 | 394,480 |
| mlp_dae | clean_truth | 0.0071 | 0.0628 | 0.2827 | nan | 60,000 |
| mlp_dae | track_purity | 0.2036 | 0.5086 | 1.8129 | 11,672 | 394,480 |
| tcn_ae | clean_truth | 0.0005 | 0.0023 | 0.0078 | nan | 60,000 |
| tcn_ae | track_purity | 0.0289 | 0.0737 | 0.1999 | 11,672 | 394,480 |
