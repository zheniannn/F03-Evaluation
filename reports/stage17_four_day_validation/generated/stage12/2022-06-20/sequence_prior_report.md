...
- These are one-day scoring results for 2022-06-20.
...
- Keep threshold: **0.5**. Tracks with fewer than
  ...
  filtering metrics (NaN score; 82,263 such track-rows here).
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| -5 | 25,450 | 194 | 0.9735 | 0.7879 | 1 | 0.0065 | gru_ae | track_purity | 0.9879 | 0.9691 | 0.9998 |
| 0 | 25,995 | 17 | 0.9854 | 0.6365 | 1 | 0.0006 | gru_ae | track_purity | 0.9756 | 0.8824 | 0.9999 |
| 3 | 24,105 | 4 | 0.9844 | 0.5524 | 1 | 0 | gru_ae | track_purity | 0.9697 | 1 | 1 |
| 6 | 20,765 | 1 | 0.9818 | 0.4781 | 1 | 0 | gru_ae | track_purity | 0.9640 | 1 | 1 |
| -5 | 25,450 | 194 | 0.9735 | 0.7879 | 1 | 0.0065 | mlp_dae | track_purity | 0.9896 | 1 | 1 |
| 0 | 25,995 | 17 | 0.9854 | 0.6365 | 1 | 0.0006 | mlp_dae | track_purity | 0.9766 | 1 | 1 |
| 3 | 24,105 | 4 | 0.9844 | 0.5524 | 1 | 0 | mlp_dae | track_purity | 0.9676 | 1 | 1 |
| 6 | 20,765 | 1 | 0.9818 | 0.4781 | 1 | 0 | mlp_dae | track_purity | 0.9609 | 1 | 1 |
| -5 | 25,450 | 194 | 0.9735 | 0.7879 | 1 | 0.0065 | tcn_ae | track_purity | 0.9535 | 0.9588 | 0.9997 |
| 0 | 25,995 | 17 | 0.9854 | 0.6365 | 1 | 0.0006 | tcn_ae | track_purity | 0.9346 | 0.7647 | 0.9998 |
| 3 | 24,105 | 4 | 0.9844 | 0.5524 | 1 | 0 | tcn_ae | track_purity | 0.9312 | 1 | 1 |
| 6 | 20,765 | 1 | 0.9818 | 0.4781 | 1 | 0 | tcn_ae | track_purity | 0.9368 | 1 | 1 |

## Model comparison

- **gru_ae**: mean false reduction 0.963, mean true retention 0.974.
- **mlp_dae**: mean false reduction 1.000, mean true retention 0.974.
- **tcn_ae**: mean false reduction 0.931, mean true retention 0.939.

## Range-bin behavior

| model | range_bin | tracks | true_retention | false_reduction | median_score |
|---:|---:|---:|---:|---:|---:|
| gru_ae | 0-50 km | 51,123 | 0.9956 | 0.9629 | 1 |
| gru_ae | 50-100 km | 43,714 | 0.9474 | nan | 0.9103 |
| gru_ae | 100-200 km | 1,694 | 0.8331 | nan | 0.7895 |
| mlp_dae | 0-50 km | 51,123 | 0.9949 | 1 | 1 |
| mlp_dae | 50-100 km | 43,714 | 0.9453 | nan | 0.9206 |
| mlp_dae | 100-200 km | 1,694 | 0.8426 | nan | 0.7749 |
| tcn_ae | 0-50 km | 51,123 | 0.9966 | 0.9309 | 1 |
| tcn_ae | 50-100 km | 43,714 | 0.8803 | nan | 0.8297 |
| tcn_ae | 100-200 km | 1,694 | 0.4227 | nan | 0.4185 |
...
|---:|---:|---:|---:|---:|
| gru_ae | 0.5205 | 6.9222 | 0.4241 | 3.9963 |
| mlp_dae | 0.2455 | 3.7688 | 0.2051 | 2.1799 |
| tcn_ae | 0.0381 | 0.3557 | 0.0290 | 0.2277 |
...
Calibration tracks: dates 2022-06-20; thresholds 3, 6 dB; eligibility target_fraction >= 0.95 and purity >= 0.95 (higher thresholds are used for calibration because they yield cleaner, more reliable high-purity true tracks).
...
| gru_ae | track_purity | 0.4241 | 1.0166 | 3.9963 | 14,924 | 515,316 |
| mlp_dae | clean_truth | 0.0071 | 0.0628 | 0.2827 | nan | 60,000 |
| mlp_dae | track_purity | 0.2051 | 0.5409 | 2.1799 | 14,924 | 515,316 |
| tcn_ae | clean_truth | 0.0005 | 0.0023 | 0.0078 | nan | 60,000 |
| tcn_ae | track_purity | 0.0290 | 0.0761 | 0.2277 | 14,924 | 515,316 |
